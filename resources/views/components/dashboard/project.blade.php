                ...
                <ul>
                    ...
                    <li class="mb-2">
                        <x-side-link href="{{--{{ route('dashboard.employee') }}--}}" :active="request()->routeIs('dashboard.employee')" class="flex">
                            <svg class="{{ request()->routeIs('dashboard') ? 'h-6 w-6 text-customColor' : 'h-6 w-6 text-gray-400' }} mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon">
