        ...
        <div class="mt-4 flex justify-center bg-white">
            <form action="{{ route('pointage.show') }}" method="GET">
                ...
                <div class="flex justify-center gap-4 p-2 bg-gray-100 border rounded">
                    <button type="submit" name="hour_type" value="day_hours" class="border hover:bg-custom-900 text-black font-bold py-2 px-4 rounded text-sm hover:bg-green-500 hover:text-white {{ $hourType === 'day_hours' ? 'bg-green-500 text-white' : 'bg-white' }}">Jour</button>
                    <button type="submit" name="hour_type" value="night_hours" class="border hover:bg-custom-900 text-black font-bold py-2 px-4 rounded text-sm hover:bg-purple-500 hover:text-white {{ $hourType === 'night_hours' ? 'bg-purple-500 text-white' : 'bg-white' }}">Nuit</button>
                    <button type="submit" name="hour_type" value="holiday_hours" class="border hover:bg-custom-900 text-black font-bold py-2 px-4 rounded text-sm hover:bg-yellow-500 hover:text-white {{ $hourType === 'holiday_hours' ? 'bg-yellow-500 text-white' : 'bg-white' }}">Férié</button>
                    <button type="submit" name="hour_type" value="rtt_hours" class="border hover:bg-custom-900 text-black font-bold py-2 px-4 rounded text-sm hover:bg-cyan-500 hover:text-white {{ $hourType === 'rtt_hours' ? 'bg-cyan-500 text-white' : 'bg-white' }}">RTT</button>
                </div>
            </form>
        </div>
